...
class SyncPage(Generic[ItemT]):
    ...
    def get_next_page(self) -> "SyncPage[ItemT]":
        ...
        return SyncPage(self._fetcher, next_request, body, self._scheme, self._cast_item)
...
class AsyncPage(Generic[ItemT]):
    ...
    async def get_next_page(self) -> "AsyncPage[ItemT]":
        ...
        return AsyncPage(self._fetcher, next_request, body, self._scheme, self._cast_item)
